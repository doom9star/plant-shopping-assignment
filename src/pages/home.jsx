      ...
      >
        <div className="w-50">
          ...
          <p className="mb-4">
            ...
            and beautiful! Whether you're a seasoned gardener or just starting
            your journey of nurturing plants, we offer a wide variety of options
            to suit every space and style. From vibrant indoor plants that
            purify the air to low-maintenance succulents perfect for busy
